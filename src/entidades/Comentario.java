...
@NamedQueries({
		@NamedQuery(name = "Comentario.findAllOrdenado", query = "SELECT c FROM Comentario c order by c.idcomentario DESC"),
		@NamedQuery(name = "Comentario.findComentario", query = "SELECT c FROM Comentario c WHERE UPPER(c.incidencia.idIncidencia) LIKE UPPER(:id)") })
